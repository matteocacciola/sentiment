...
describe('VADER evaluateScores', () => {
  ...
  it('should return a sentiment category of "undefined" if the score cannot be calculated', async () => {
    const results = await evaluateScores(company, [''], scoreThreshold);
